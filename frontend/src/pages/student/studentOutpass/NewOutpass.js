                    ...
                    <div className="grid">
                        ...
                        <div className="col-12 md:col-6">
                            ...
                            <div className="flex justify-content-between my-5">
                                ...
                                <div className="flex">
                                    ...
                                    <input value={leaveTime} onValueChange={(e) => setLeaveTime(e.value)} type="time" id="ltime" className='w-15rem h-3rem text-2xl'/>
                                </div>
                            </div>
                            <Divider layout="horizontal"></Divider>
                        </div>
                        ...
                        <div className="col-12 md:col-6">
                            ...
                            <div className="flex justify-content-between my-5">
                                ...
                                <input value={returnTime} onValueChange={(e) => setReturnTime(e.value)} type="time" id="rtime" className='w-15rem h-3rem text-2xl'/>
                            </div>
                            <Divider layout="horizontal"></Divider>
                        </div>
